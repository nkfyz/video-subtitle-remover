...
from backend.scenedetect.platform import FakeTqdmLoggingRedirect, logging_redirect_tqdm
...
def main():
    ...
    log_redirect = FakeTqdmLoggingRedirect() if cli_ctx.quiet_mode else logging_redirect_tqdm(loggers=[logger])
