...
from watermark_remover.backend.scenedetect.scene_detector import SceneDetector
...
class ContentDetector(SceneDetector):
    ...
    def _calculate_frame_score(self, frame_num: int, frame_img: numpy.ndarray) -> float:
        ...
        score_components = ContentDetector.Components(
            ...
            delta_edges=(0.0 if edges is None else _mean_pixel_distance(edges, self._last_frame.edges)),
        )
